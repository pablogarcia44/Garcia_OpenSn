...
mat_names = {'clad_cellinstru_1_family', 'clad_guide_1_family', 'clad_pincell_1_family', 'fuel_pincell_1_family', 'gap_pincell_1_family', 'instru_cellinstru_1_family', 'moderator_guide_1_family', 'moderator_pincell_1_family', 'water_cellinstru_1_family', 'water_guide_1_family', 'water_outside'}
materials = {}
my_xs = {}
xs_file = 'mgxs_2I.h5'
...
lbs_options = {
    ...
    write_restart_path = "2I_restart/2I",
}
...
MPIBarrier()
log.Log(LOG_0,'ici')
fieldfunc.ExportToVTKMulti(fflist,'flux_2I')
