...
mat_names = {'AIC_aic_1_family', 'clad_aic_1_family', 'clad_guide_instru_1_family', 'clad_pincell_1_family', 'fuel_pincell_1_family', 'gap_aic_1_family', 'gap_pincell_1_family', 'guide_aic_1_family', 'moderator_aic_1_family', 'moderator_instru_1_family', 'moderator_pincell_1_family', 'water_guide_instru_1_family', 'water_outside'}
materials = {}
my_xs = {}
xs_file = 'mgxs_2G.h5'
...
lbs_options = {
    ...
    write_restart_path = "2G_restart/2G",
}
...
MPIBarrier()
log.Log(LOG_0,'ici')
fieldfunc.ExportToVTKMulti(fflist,'flux_2G')
