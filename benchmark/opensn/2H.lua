...
mat_names = {'B4C_b4c_1_family', 'clad_b4c_1_family', 'clad_guide_instru_1_family', 'clad_pincell_1_family', 'fuel_pincell_1_family', 'gap_b4c_1_family', 'gap_pincell_1_family', 'guide_b4c_1_family', 'moderator_b4c_1_family', 'moderator_instru_1_family', 'moderator_pincell_1_family', 'water_guide_instru_1_family', 'water_outside'}
materials = {}
my_xs = {}
xs_file = 'mgxs_2H.h5'
...
lbs_options = {
    ...
    write_restart_path = "2H_restart/2H",
}
...
MPIBarrier()
log.Log(LOG_0,'ici')
fieldfunc.ExportToVTKMulti(fflist,'flux_2H')
